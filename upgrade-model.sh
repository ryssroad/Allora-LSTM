...
if [[ "$installdep" =~ ^[Yy]$ ]]; then
    ...
    wget -q https://github.com/0xtnpxsgt/Allora-Comprehensive-Guide/raw/BiLSTM/enhanced_bilstm_model.pth -O /root/allora-huggingface-walkthrough/enhanced_bilstm_model.pth
    wait
